...
**Redirects to `/obs-setup`.** The setup command is the single canonical way to create a vault — it handles vault creation, project scaffolding, and CLAUDE.md installation in one flow.
